            ...
            {todos.map((todo: Todo, index: number) => {
              return (
                ...
                >
                  ...
                  {/* text-ellipsis, truncate 적용안됨? ㅠㅠ */}
                  <td className="border-r-2 border-r-gray-400/30 w-[30rem] text-ellipsis">
                    {todo.title}
                  </td>
                  <td className="border-r-2 border-r-gray-400/30 w-[40rem] text-ellipsis">
                    {todo.contents}
                  </td>
                  {/* overflow-hidden  trancate? ellipsis 
				  다 적용해봤지만 길어지면 그냥 줄바꿈..넓이, 길이도 설정해봤으나 안됨*/}
